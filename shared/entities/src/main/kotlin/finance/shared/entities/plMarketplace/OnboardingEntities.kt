...
class PlEventAuditEntities(eventTypeId: EntityID<String>) : Entity<String>(eventTypeId) {
    ...
    var eventSource by PlEventAuditSchema.eventSource
    var journeyType by PlEventAuditSchema.journeyType
    var eventDescription by PlEventAuditSchema.eventDescription
    var entityType by PlEventAuditSchema.entityType
    var loggedAt by PlEventAuditSchema.loggedAt
    var eventMetadata by PlEventAuditSchema.eventMetaData
}
